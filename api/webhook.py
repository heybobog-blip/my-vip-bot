...
SELECTABLE_ROOMS = {
    "300": [
        {"id": ID_V1, "name": "VVIP V1 (ถาวรอัพคลิปถึง 22/01/69)"},          # ทางเลือก 1
        {"id": ID_MONTHLY, "name": "VVIP รายเดือน (30 วัน)"} # 🔴 ทางเลือก 2 (มาใหม่)
    ],
    "500": [
        {"id": ID_SAVE, "name": "VVIP V1 SAVE (ถาวรอัพคลิปถึง 22/01/69)"},     
...
└ เลือกรับ: VVIP V1 (ถาวรอัพคลิปถึง 22/01/69) <b>หรือ</b> VVIP รายเดือน
━━━━━━━━━━━━━━━━━━
